...
struct VerificationHelpSheet: View {
    ...
    private var intro: some View {
        Text("Forma checks your habits against Apple Health and Screen Time so the leaderboard stays honest. Verifiable habits auto-check the moment evidence shows up — you can't tap them done yourself, and self-reporting them counts for less.")
            .font(.system(size: 13))
            .foregroundStyle(.secondary)
